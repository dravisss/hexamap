...
**Versão atual: 10.3.0 · beta pública · MIT**
...
um uso sem Python, baixe o `hexmap-studio-10.3.0-standalone.zip`, confirme o
...
10.3. A seleção de pasta depende das permissões e APIs do navegador; bundles
